...
cat("\n")
if(parallel){
cat("Enter inter-subj CV (%) (e.g. 20): ")
}
else{
cat("Enter intra-subj CV (%) (e.g. 20): ")
}
CV1 <- 20
CV<-CV1/100
cat(" 20\n")
...
cat("\n")
if(parallel){
cat("Enter inter-subj CV (%)(or press Enter to use default value: 20 ): ")
}
else{
cat("Enter intra-subj CV (%)(or press Enter to use default value: 20 ): ")
}
CV1 <- readline()
  ...
  if(i==CV[1]){
   ...
   title=paste(
      paste("--------------------------------------------------------------------------\n",
            ...
            "           Target power =",
               format(round(target*100,2),nsmall=2,width=3),"%\n",
            "       Intra-subject CV =",format(i*100,nsmall=1,width=3),"%\n\n "),
