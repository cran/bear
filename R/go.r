...
text(100,100,"Welcome to bear v2.6.4",cex = 1.2)
text(100,70,"bear is developed by Hsin-ya Lee & Yung-jin Lee.",cex = 1.2)
text(100,60,"Kaohsiung, Taiwan",cex = 1.2)
text(100,40,"bear is under license of GPL-2|GPL-3.",cex = 1.2)
text(100,20,"Reading or generating set-up files now. Please wait...",cex = 1.2)
