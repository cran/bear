\name{description_TOST_lnAUC0INF}

\alias{description_TOST_lnAUC0INF}

\title{Description for Two One-Sided Test for lnAUC0INF}

\description{
Interpretation:
Ho: MEAN-test/MEAN-ref =< ln(lower acceptance) or  MEAN-test/MEAN-ref >= ln(Upper acceptance)
Ha: ln(lower acceptance) < MEAN-test/MEAN-ref < ln(Upper acceptance)
  If at least one of P value is more than 0.05, we will not reject the null
hypothesis (Ho).
}
\references{
